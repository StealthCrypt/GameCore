        ...
        <div className="bg-black rounded-lg max-w-7xl mx-auto" style={{
          ...
          <ol className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 p-2 ml-2 mr-2">
            ...
            {[...Array(3)].map((_, index) => (
              ...
              <li
                key={index}
                className="bg-gray-900 rounded-lg drop-shadow-[0_0_30px_rgba(0,0,0,1)]">
                <Image
                  ...
                  height={150}
                />
                <div className="p-2 mx-auto mt-5 bg-gradient-to-r from-purple-600 to-purple-400 rounded-lg">
