...
export default function Profile() {
  return (
    ...
    <div className="flex items-center gap-x-4 shadow-lg shadow-white mb-3 p-5 bg-black rounded-lg borderwidth-5 justify-content-center w mt-20 ml-20 mr-20 mb-20 pb-300" style={{ borderWidth: '2px', borderStyle: 'solid', borderColor: '#ffffffff' }}>
      <ol>
        <li>
          <svg className="h-50 w-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <h1 className="text-5xl font-bold -mt-20">Username</h1>
    </div>
